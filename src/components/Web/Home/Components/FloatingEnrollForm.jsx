...
export default function FloatingEnrollForm() {
  return (
    ...
    >
      <div className="size-full p-6 border-5 border-custom-500 rounded-2xl bg-custom-100 grid justify-center items-center relative">
        <button
          className="absolute top-0 right-0 bg-custom-400 p-3 rounded-bl-2xl rounded-tr-xl hover:bg-custom-600 cursor-pointer transition-all duration-200"
          onClick={() => {
